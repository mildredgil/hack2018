      ...
      return this.each(function () {
        ...
        if (!$.isEmptyObject(data)) {
          ...
          var highlight = function (string, $el) {
            var img = $el.find('img');
            //journeyEdited
            var _text = $el.text().toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, "");
            var _string = string.toLowerCase().normalize('NFD').replace(/[\u0300-\u036f]/g, "");

            var matchStart = _text.indexOf("" + _string.toLowerCase() + ""),
          ...
          $input.off('keyup.autocomplete focus.autocomplete').on('keyup.autocomplete focus.autocomplete', function (e) {
            ...
            if (oldVal !== val) {
              ...
              if (val.length >= options.minLength) {
                for (var key in data) {
                  //journeyEdited
                  _key  = key.normalize('NFD').replace(/[\u0300-\u036f]/g, "");
                  _val = val.normalize('NFD').replace(/[\u0300-\u036f]/g, "");

                  if (data.hasOwnProperty(key) && _key.toLowerCase().indexOf(_val) !== -1) {
                    // Break if past limit
  ...
  $.fn.material_chip = function (options) {
    ...
    this.handleEvents = function () {
      ...
      if(isAndroid) {
        ...
        self.$document.off('textInput.chips').on('textInput.chips', function (e) {
        ...
        self.$document.off('textInput.chips-add', SELS.CHIPS + ' ' + SELS.INPUT).on('textInput.chips-add', SELS.CHIPS + ' ' + SELS.INPUT, function (e) {
          var char_used = e.originalEvent.data;
